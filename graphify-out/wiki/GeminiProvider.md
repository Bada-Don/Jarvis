...
> God node · 151 connections · `Jarvis-aws-migration\backend\llm_provider.py`
...
### calls
- [[._execute_write_file_step()]] `INFERRED`
- [[.init_provider()]] `INFERRED`
- [[.init_provider()]] `INFERRED`
- [[test_provider_switching()]] `INFERRED`
- [[test_gemini_provider()]] `INFERRED`

### contains
- [[llm_provider.py]] `EXTRACTED`
- [[llm_provider.py]] `EXTRACTED`

### inherits
- [[LLMProvider]] `EXTRACTED`

### method
- [[.generate_content()]] `EXTRACTED`
- [[.__init__()]] `EXTRACTED`

### rationale_for
- [[Gemini implementation of LLMProvider.]] `EXTRACTED`
- [[Gemini implementation of LLMProvider.]] `EXTRACTED`

### uses
- [[PlanExecutor]] `INFERRED`
- [[PlannerService]] `INFERRED`
