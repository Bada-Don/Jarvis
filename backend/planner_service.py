...
Example: After creating "AI Lab" folder with files, add: `explorer "%USERPROFILE%\\OneDrive\\Desktop\\AI Lab"`
...
1. **Create folder** using `shell_command` (e.g., `mkdir "%USERPROFILE%\\OneDrive\\Desktop\\LabCode"`)
