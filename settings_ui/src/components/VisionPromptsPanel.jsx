...
export default function VisionPromptsPanel({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Vision Prompts</h2>
      ...
      <div>
        <div className="mb-4 p-3 bg-gray-50 border border-gray-200 rounded">
          ...
          <div className="text-xs text-gray-600">
            <span className="font-medium">Required placeholders:</span>{' '}
            {activeConfig.requiredPlaceholders.map((ph, idx) => (
              <span key={ph}>
                <code className="bg-gray-200 px-1 py-0.5 rounded">{ph}</code>
        ...
        {missingPlaceholders.length > 0 && (
          <div className="mb-4 p-3 bg-red-50 border border-red-400 text-red-700 rounded">
            <p className="font-medium text-sm mb-1">⚠️ Missing Required Placeholders:</p>
            <ul className="list-disc list-inside text-sm">
              {missingPlaceholders.map((ph) => (
                <li key={ph}>
                  <code className="bg-red-100 px-1 py-0.5 rounded">{ph}</code>
                </li>
              ))}
            </ul>
          </div>
