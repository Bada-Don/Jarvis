...
import { Upload, Download, Check, Lightbulb } from "lucide-react";
import { api } from "../api";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Export your current configuration to share with others or create
          backups. Import configurations to quickly switch between different
          setups.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-lg p-6 border border-[#404040] shadow-m hover:shadow-l transition-shadow duration-200">
          ...
          <button
            ...
            className={`w-full px-4 py-2 rounded-lg font-medium transition-all shadow-s hover:shadow-m ${
              isExporting
        ...
        <div className="rounded-lg p-6 border border-[#404040] shadow-m hover:shadow-l transition-shadow duration-200">
          <div className="flex items-start mb-4">
            <Download className="w-8 h-8 mr-4 text-green-600" />
            <div>
              <h3 className="text-lg font-semibold text-white mb-1">
                Import Configuration
              </h3>
      ...
      <div className="border border-[#404040] rounded-lg p-4 shadow-s">
        ...
        <ul className="list-disc list-inside space-y-1 text-sm text-blue-700">
          <li>
            Export your configuration before making major changes to create a
            backup
          </li>
          <li>
            Share configuration files with team members to ensure consistent
            settings
          </li>
          <li>
            Configuration files include metadata like export date and version
            for tracking
          </li>
          <li>
            Invalid settings in imported files will be skipped with warnings
            displayed
          </li>
        </ul>
      </div>
